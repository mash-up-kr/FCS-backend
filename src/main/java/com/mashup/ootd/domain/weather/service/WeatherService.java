...
public class WeatherService {
    ...
    public String getPostWeatherInfo(String lat, String lon) {
        ...
        try {
            ...
            String apiURL = new StringBuilder().append("api.openweathermap.org/data/2.5/onecall?").append("lat=").append(lat).append("&lon=").append(lon).append("&exclude=minute,hourly,daily").append("appid=b692c24a9d64e29901f2fa8c899d1b9f").toString();
